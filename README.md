...
### Day-2 (Monday-MLK Day):
Have at least run a baseline model and looked metrics.

### Day 2 (Tuesday):
Be prepared to talk about your data, your problem, and your baseline model.
An outline of your final presentation is also expected.

### Day 3 (Wednesday morning):
Check-ins in the morning. Run through of your presentation.
